...
CREATE TABLE `bags` (
  ...
  `bag_price` float DEFAULT NULL,
  `bag_desc` varchar(300) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `BIndex` (`bag_name`)
...
INSERT INTO `bags` VALUES (1,'Jansport Bag',31.1,'Women\'s bag'),(2,'Swiss Gear',13.3,'Man\'s bag');
...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `bags` (`id`)
...
-- Dump completed on 2020-02-01 20:08:52
